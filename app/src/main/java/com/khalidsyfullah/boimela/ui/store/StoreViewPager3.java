...
//        categoryDataModels.add(new CategoryDataModel("Biography","https://www.adazing.com/wp-content/uploads/2012/09/einstein.jpg",4));
        ...
        storeViewModel.getCategories().observe(getViewLifecycleOwner(), new Observer<ArrayList<CategoryDataModel>>() {
            @Override
            public void onChanged(ArrayList<CategoryDataModel> categoryDataModels) {

                categoryAdapter.setCategoryDataModels(categoryDataModels);
